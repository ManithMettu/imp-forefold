...
export default function Features() {
  ...
  return (
    <section id="products" className="py-20 bg-gray-100 reveal-element">
          ...
          {modules.map((feature, index) => (
            ...
            >
              <div className="overflow-hidden">
                <div
                  className={`w-full h-48 bg-gradient-to-br ${feature.cardGradient} flex items-center justify-center p-6 group-hover:scale-105 transition-transform duration-500`}
                >
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${feature.iconGradient} rounded-2xl shadow-lg flex items-center justify-center text-white transform rotate-12 group-hover:rotate-0 group-hover:scale-110 transition-all duration-500`}
                  >
              ...
              <div className="p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-bold mb-4 flex items-center reveal-element">
                  <span
                    className={`bg-clip-text text-transparent bg-gradient-to-r ${feature.iconGradient}`}
                  >
                    {feature.title}
                  </span>
                </h3>
                ...
                <a
                  href="#"
                  className={`inline-flex items-center font-medium transition-colors duration-300 ${feature.linkColor}`}
                >
                  Learn more
